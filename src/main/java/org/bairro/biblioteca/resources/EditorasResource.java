...
import org.bairro.biblioteca.services.EditorasService;
...
public class EditorasResource {
	...
	@POST
	public Response save(Editoras entity) {
		try {
	...
	@PUT
	public Response update(Editoras entity) {
		try {
